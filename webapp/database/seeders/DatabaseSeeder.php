    ...
    public function run()
    {
        ...
        DB::insert('insert into tb_org (cnpj, cep, endereco, phone, country, nome_fantasia)
            ...
            array(
                '000000000000000000',
                00000000,
                'Rua teste 1, n 2 - São Paulo, SP - Brazil',
                '+55 (00) 00000-0000',
                'Brazil',
        ...
        DB::insert('insert into tb_org (cnpj, cep, endereco, phone, country, nome_fantasia)
            ...
            array(
                '1111111111111111111',
                11111111,
                'Rua teste 1, n 1 - São Paulo, SP - Brazil',
                '+55 (00) 11111-1111',
                'Brazil',
        ...
        DB::insert('insert into tb_org (cnpj, cep, endereco, phone, country, nome_fantasia)
            ...
            array(
                '222222222222222222',
                222222222,
                'Rua teste 2, n 2 - São Paulo, SP - Brazil',
                '+55 (00) 22222-2222',
                'Brazil',
        ...
        DB::insert('insert into tb_org (cnpj, cep, endereco, phone, country, nome_fantasia)
            ...
            array(
                '1111111111111111',
                111111,
                'Rua teste 3, n 3 - São Bernardo do Campo, SP - Brazil',
                '+55 (00) 33333-3333',
                'Brazil',
