...
<html lang="pt-BR">
    ...
    <meta charset="utf-8">
        ...
        <title>Justificativa - Requisição</title>
    ...
    <body onload="onloadPage()">
        <div id ="div1">
            <form id="frm_collect_justify" method="post" action="/institucional/requisicoes/doAction">
                ...
                <textarea id="txtJustify" name="txtJustify" rows="4" cols="50"></textarea><br><br>

                <p>Data de agendamento: <?php echo date('d/m/Y H:i:s', $datetime); ?></p><br>
                <?php 
                
                
                    if($op_type=='change'){
                        echo 'Alterar Data<input type="radio" name="txtRadio" id="txtRadio" onclick="ChangeDate()"><br>
                            Cancelar alteração<input type="radio" name="txtRadioResetDate" id="txtRadioResetDate" onclick="CancelDate()"><br>';
                        ...
                        echo '<br><br><p>*** Ao alterar uma requisição, esta automaticamente estará sendo aprovada.</p>';
                    }else if($op_type=="repprove"){
                        echo '<input type="checkbox" name="txtShouldDelete" id="txtShouldDelete" value="yes"> Deletar requisição';
                    }
                
                ?><br>
                <input type="submit" class="btn btn-warning" value="Realizar operação">
            </form>
        </div>
    </body>
</html>
