...
<html>
	...
	<body id = "grid">
        ...
        <h1>Os dados de sua instituição foram enviados para análise, 
            aguarde nosso retorno na caixa de entrada do email em que foi informado no cadastro.
        </h1>
        <a href="/home">Retornar a página inicial</a>
    </body>
</html>
